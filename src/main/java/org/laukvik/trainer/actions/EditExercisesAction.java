...
public class EditExercisesAction extends AbstractJournalAction {

	private static final long serialVersionUID = 1L;
	public final static String COMMAND_KEY = "exercises.edit";

	public EditExercisesAction( JournalPanel journalPanel ) {
		super(journalPanel);
		putValue( Action.NAME, JournalHelper.getLanguage( getLocale(), COMMAND_KEY ) );
		putValue( Action.ACTION_COMMAND_KEY, COMMAND_KEY );
		putValue( Action.SMALL_ICON, JournalHelper.getIcon( "exercises.png" ) );
	...
	public void actionPerformed(ActionEvent e) {
		getJournalPanel().handleOpenExerciseEditorDialog();
	}
